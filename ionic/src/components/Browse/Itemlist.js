...
import { editActive,storerestaurants,storeMenuItems } from "./../../Slices/RestaurantsSlice";
...
function Itemlist() {
  ...
  const fetchrestaurants=()=>{
    ...
    .then(res => {dispatch(storerestaurants(res.data))
    })
    .catch(err =>{
  ...
  const fetchMenuItems=()=>{
    ...
    .then(res => {dispatch(storeMenuItems(res.data))
    })
    .catch(err =>{
